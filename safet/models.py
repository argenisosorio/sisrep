...
class ReporteAvances(models.Model):
    ...
    porc_act_1 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_2 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_3 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_4 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_5 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_6 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_7 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_8 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_9 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_10 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_11 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_12 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_13 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_14 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_act_15 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    # Porcentaje de avance de las actividades del proyecto.
    porc_avan_act_1 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_2 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_3 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_4 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_5 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_6 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_7 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_8 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_9 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_10 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_11 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_12 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
    porc_avan_act_13 = models.DecimalField(max_digits=3, decimal_places=1, default=0.0)
